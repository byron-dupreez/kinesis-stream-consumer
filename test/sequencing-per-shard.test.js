...
// =====================================================================================================================
// compareAnyKeyMessages - kinesis
// =====================================================================================================================

test(`compareAnyKeyMessages for kinesis with NO sequence property names`, t => {
...
test(`compareAnyKeyMessages for kinesis with key & sequence property names with difference in 4th seq # part`, t => {
...
test(`compareAnyKeyMessages for kinesis with key & sequence property names with difference in 3rd seq # part`, t => {
  const context = createContext('kinesis', [], ['k1', 'k2'], ['n1', 'n2', 'n3', 'n4']);
...
test(`compareAnyKeyMessages for kinesis with key & sequence property names with difference in 2nd seq # part`, t => {
  const context = createContext('kinesis', [], ['k1', 'k2'], ['n1', 'n2', 'n3', 'n4']);
  const shardId1 = 'shardId-000000000000';
  const seqNo1 = '49545115243490985018280067714973144582180062593244200961';
...
test(`compareAnyKeyMessages for kinesis with key & sequence property names with difference in 1st seq # part`, t => {
  const context = createContext('kinesis', [], ['k1', 'k2'], ['n1', 'n2', 'n3', 'n4']);
  const shardId1 = 'shardId-000000000000';
  const seqNo1 = '49545115243490985018280067714973144582180062593244200961';
...
test(`compareAnyKeyMessages for kinesis with key & sequence property names with no differences in any seq # part`, t => {
  const context = createContext('kinesis', [], ['k1', 'k2'], ['n1', 'n2', 'n3', 'n4']);
